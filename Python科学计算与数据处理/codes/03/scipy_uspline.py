...
pl.subplot(211)
pl.plot(x1, y1, ".", label=u" Data point")
pl.plot(sx1, sy1, label=u" Spline curve ")
pl.legend()

pl.subplot(212)
pl.plot(x2, y2, ".", label=u" Data point")
pl.plot(sx2, sy2, linewidth=2, label=u" Spline curve")
pl.plot(x2, np.sin(x2), label=u" Noiseless curve ")
pl.legend()
pl.show()
